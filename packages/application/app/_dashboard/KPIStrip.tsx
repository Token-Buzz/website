...
export function KPIStrip() {
  ...
  const cards = [
    {
      label: "Mentions · 24h",
      value: kpis?.mentions24h ?? 0,
      footer: "across all tracked tokens",
    },
    {
      label: "Tokens tracked",
      value: kpis?.tokenCount ?? 0,
      footer: "in the platform",
    },
    {
      label: "Net sentiment",
      value: kpis?.netSentiment ?? 0,
      footer: kpis && kpis.netSentiment > 0 ? "bullish" : kpis && kpis.netSentiment < 0 ? "bearish" : "neutral",
    },
  ];
