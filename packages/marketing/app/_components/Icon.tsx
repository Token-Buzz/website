...
export type IconName =
  | 'arrowR' | 'arrowDown' | 'check' | 'star' | 'pulse' | 'bolt'
  | 'eye' | 'cpu' | 'chart' | 'play' | 'plus' | 'list' | 'sparkle'
  | 'x' | 'twitter' | 'github' | 'discord'
...
const PATHS: Record<IconName, string[]> = {
  ...
  sparkle:  [
    'M12 3l1.8 4.8L18.5 9.6l-4.8 1.8L12 16.2l-1.7-4.8L5.5 9.6l4.8-1.8z',
    'M19 14l.8 2.1L22 17l-2.2.8L19 20l-.8-2.1L16 17l2.2-.8z',
  ],
